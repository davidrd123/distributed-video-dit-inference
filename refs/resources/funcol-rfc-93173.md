...
- **This RFC explains why Run 12b worked**: in TP=2 + compile, collectives wrapped by `torch._dynamo.disable()` caused heavy graph fragmentation; switching to compiler-friendly functional collectives restored steady-state performance. See: `scope-drd/notes/FA4/h200/tp/bringup-run-log.md` (Runs 8–12b).
